...
exports.assignAll = exports.cflog = exports.objlog = exports.isNot = exports.is = exports.get = void 0;
...
var is = {
    ...
    empty: function (a) { return (is.object(a) && get.size(a) === 0) || ((is.iterable(a) && a.length === 0)); },
